(function () {
  ...
  function answerFor(raw) {
    ...
    if (/(elevator|pitch|introduce|summary|tl;?dr|who is brielle|about brielle|tell me about)/.test(q)) {
      return {
        text:
          "30-second pitch: Brielle Picard is a Penn State IST senior (HCDD, expected May 2027; GPA 3.51) who combines technology, design, and business strategy to solve complex problems. At Sales Gauge she redesigned and implemented the full site, set up Google Analytics (+162% users / +156% engagement over ~1 year), and turned an Excel High Value Trade Table into a sellable web product. She also consults with AFA Women’s Health on rebranding, podcasts, media days, and a comprehensive website overhaul.",
        links: [
