(function () {
  ...
  function answerFor(raw) {
    ...
    if (!q) {
      return {
        text:
          "Ask about Brielle’s experience, projects, design process, technical skills, AI work, business impact, collaboration style, education, or contact details.",
        links: [],
      };
    }
    ...
    if (/(hello|hi\b|hey|who are you|what are you)/.test(q)) {
      return {
        text:
          "I’m BrieBot — a guide to Brielle Picard’s background and work. I can explain her projects, measurable results, design and development process, AI experience, collaboration style, education, career goals, or contact details.",
        links: [
    ...
    if (/(elevator|pitch|introduce|summary|tl;?dr|who is brielle|about brielle|tell me about)/.test(q)) {
      return {
        text:
          "30-second pitch: Hi, I’m Brielle Picard, a Penn State HCDD senior who combines technology, design, and business strategy to turn complex problems into useful digital experiences. At Sales Gauge, I redesigned and implemented the full website, set up analytics that documented 162% user growth, and helped turn an Excel workflow into a sellable web product. I’m seeking an entry-level role where I can bring product thinking, hands-on development, and cross-functional collaboration to create measurable impact.",
        links: [
    ...
    return {
      text:
        "I can help with Brielle’s Sales Gauge or AFA work, portfolio process, generative AI projects, design approach, front-end development, marketing and analytics, measurable impact, collaboration style, education, career goals, interview prep, or contact information.",
      links: [
        { href: KB.work, label: "Projects" },
  ...
  function resetChat(opts) {
    ...
    appendMessage("bot", {
      text:
        "Hi — I’m BrieBot. Ask about Brielle’s projects, skills, design process, technical work, AI experience, business impact, collaboration style, education, or how to reach her.",
      links: [
